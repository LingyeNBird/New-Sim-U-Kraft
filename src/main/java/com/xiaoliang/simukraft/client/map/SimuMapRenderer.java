...
/**
 * 地图渲染器：将 {@link SimuMapRegionData} 中的颜色/高度数据渲染到 {@link NativeImage}。
 * 参考 FTB Chunks 的 RenderMapImageTask，实现阴影、光照和水面效果。
 * 完全独立于 FTB/Xaero。
 */
public class SimuMapRenderer {
    ...
    /**
     * 渲染一个区域到 NativeImage。
     * 在后台线程调用，结果写入 region 的 NativeImage。
     */
